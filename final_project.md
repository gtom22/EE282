...
![dataset](https://cellxgene.cziscience.com/collections/48259aa8-f168-4bf5-b797-af8e88da6637.). The external datasets used were for markers and updated data using our analysis on existing papers adressed in each section. Full analysis can be completed without re-running cellranger as that was used to enhance the results.
